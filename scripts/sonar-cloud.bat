@echo off
set workspace=C:\Users\Chante\Documents\ProyectosEclipce\DemoTest
...
call mvn sonar:sonar -Dsonar.organization=jchantej-github -Dsonar.host.url=https://sonarcloud.io -Dsonar.login=53557d34bb4a1ac6258f7f91c81cb5dcb522aeeb --settings settings.xml
pause
